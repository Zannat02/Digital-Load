...
document.addEventListener('DOMContentLoaded', function () {
  ...
  /* ============================================
        DESKTOP DROPDOWNS — Touch-safe toggle
        (Fixes iOS Safari :hover persistence bug)
     ============================================ */

  const desktopGroups = document.querySelectorAll('header nav .group');
  ...
  desktopGroups.forEach(function (group) {
    ...
    trigger.addEventListener('click', function (e) {
      ...
      const isOpen = group.classList.contains('touch-open');

      desktopGroups.forEach(function (otherGroup) {
        otherGroup.classList.remove('touch-open');
      });
      ...
      if (!isOpen) {
        ...
        group.classList.add('touch-open');
  ...
  document.addEventListener('click', function (e) {
    ...
    desktopGroups.forEach(function (group) {
      ...
      if (!group.contains(e.target)) {
        group.classList.remove('touch-open');
      }
